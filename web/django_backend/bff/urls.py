...
urlpatterns = [
    ...
    path("workflows/collab-templates/", workflows.proxy_collab_templates, name="bff_collab_templates"),
    path("workflows/collab-templates/generate/", workflows.proxy_collab_template_generate, name="bff_collab_template_generate"),
